            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="tab-content">
                        <div id="menu1">
                            {!! Form::model($hotel,['route'=>['hotel.images.update',$hotel->id],'method'=>'post','class'=>'form-horizontal','enctype'=> 'multipart/form-data']) !!}
                            ...
                            <div class="col-md-3">
                                <div class="img-thumbnail">
                                    ...
                                    <div style="padding-top: 10px;" class="pull-right">
                                        ...
                                        <form action="{{ route('hotel.images.delete', $image->id) }}" method="post">
